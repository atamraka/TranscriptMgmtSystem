...
//		String mediaFile = "<applet code=SimplePlayerApplet width=320 height=300><param name=file value=\"sun.avi\"></applet>";
		String mediaFile = "G:/sem/Fall2015/maths/ch4/Lecture 3.wmv";
...
//		}
		...
		try {
			...
			if ((mrl = new MediaLocator(file.toURL())) == null)
